...
getopt.ali getopt.o inst-check inst-check.o inst-copy inst-copy.o inst-dir \
...
obj_clean:
	...
	getopt-ada.a getopt.ali getopt.o inst-check inst-check.o inst-copy inst-copy.o \
